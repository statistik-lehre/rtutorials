...
-   <input type="checkbox" unchecked> die Vanrianz und Standardabweichung berechnen </input>
...
Stell dir vor, du sortierst 100 Personen nach dem Alter und stelst alle in  einer aufsteigenden Reihe auf, vom Baby bis zu Senioren. Dann ist z.B. das 25%-Quantil das Alter der 25. Person in dieser Reihe. Oder der 26. Person, je nachdem wie du es auslegst Oder sogar der Mittelwert des Alters der 25. und 26. Person. Es gibt nicht den "einen" Weg, Quantile zu berechnen. 
...
Die Punkte aus den obigen Grafiken sind im Vektor `alter` gespeichert. Verwende die `quantile()`-Funktion ohne weitere Argumente außer den Daten, um sich die **Quartile** ausgeben zu lassen. (Quartil so wie *quarter* = Viertel)
...
learnr::quiz(caption = "Teste dein Verständnis",
             ...
             learnr::question_radio("Je größer die Varianz...",
                                    ...
                                    allow_retry = TRUE,
                                    random_answer_order = TRUE),
             learnr::question_text("Die Streuung des Medians ist:",
                                   answer("Varianz"),
                                   answer("Standardabweichung"),
                                   answer("Interquartilsabstan", correct = TRUE),
                                   allow_retry = TRUE
                                   ))
```
