...
- Die "Stäbe" (*whiskers*) gehen von $Q1 - 1.5 \cdot IQR$ bzw. $Q3 + 1.5 \cdot IQR$, aber falls die Daten schon vorher aufhören, gehen die *whiskers* immer nur bis zum maximalen / minimalen Datenpunkt.
- Outlier (Ausreißer) ist alles, was außerhalb $Q1 - 1.5 \cdot IQR$ und $Q3 + 1.5 \cdot IQR$ (der Wiskers) liegt.
