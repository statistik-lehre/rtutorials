...
Der Wunsch, Antworten auf Fragen aus der echten Welt zu finden, ist der eigentlich motivierende Faktor hinter Statistik. Ich möchte aber gleich vorwegnehmen, um eventuellen Enttäuschungen vorzubeugen: So etwas wie definitive Wahrheiten für die echte Welt finden wir mit Statistik nicht. Damit die Werkzeuge der Statistik angewandt werden können, müssen Beobachtungen immer zunächst in Zahlen transformiert werden. Oder codiert werden in Kategorien. Wo ist die Grenze einer Kategorie? Was fällt hinein, und was nicht mehr? Bei allen statistischen Datenerhebungen gibt es Stellen, an denen diese Willkür und Potenzial zu (unbewusster) Einflussnahme besteht und wir damit sehr weit davon entfernt sind, eine Methode zu haben, die tatsächlich Wahrheitsanspruch stellen kann. 
qwerden Alleine diese Umwandlung enthält schon sehr viel Potenzial, sich zu irren - mit diesen Fragen beschäftigen wir uns in Kapitel 3. 
Aber gehen wir einmal davon aus, dass die Daten mit denen wir arbeiten, nach bester wissenschaftlichen Methode erhoben wurden, und lassen das Streben nach Objektivität beiseite.
Wir befinden uns in einem Kosmos, in dem uns ein großer Werkzeugkasten an anwendbaren Methoden beiseite steht. Und das hat tatsächlich etwas beruhigendes. 
Letztlich geht es immer darum, Situationen einzuschätzen, um Handlungsmöglichkeiten abzuleiten. Die Mathematik hält dafür eine ganze Reihe von Werkzeugen bereit. Nur müssen die Daten dafür zunächst einmal überhaupt mathematisch verarbeitbar sein.  
Willkommen in der Welt des Messens, Quantifizierens, Zählens und Wiegens. 

Die Statistik ist Werkzeug von Dabei Mithilfe von Zahlen können wir logisch und vermeintlich objektive Urteile ziehen aus 
Diesen Fokus möchte ich im Verlauf des Tutorials immer wieder herstellen, auch wenn wir uns zeitweise mit sehr theoretischen Inhalten beschäftigen.\
...
<details>
  <summary> Für alle mit alten PCs: hier klicken </summary>
