...
question("Welche Eigenschaften treffen auf den erreichten Rang in einem Wettkamp zu? (mehrere Antworten)",
  ...
  incorrect("Hilfestellung: Zusammengehörige Konzepte. Wählen Sie jeweils das passende aus!
            - quantitativ - qualitativ
            - stetig - diskret
            - intervall - ordinal
            - metrisch (Synonym: kardinal) - kategorial"),
  post_message = "Der Rang ist: \n
  - kategorial, da die Ränge mit abgrenzbaren Kategorien gleichzusetzen sind, und nicht metrisch/kardinal.  
...
- `numeric`: für reine Zahlen
:::

Nehmen wir folgenden Beispieldatensatz:

```{r echo=FALSE}
head(rtutorials::einkaufen)
```

Diese Daten wurden von Studierenden im Rahmen dieser Vorlesung im WiSe 2022-23 erhoben. 
Dabei fokussieren wir uns auf drei verschiedene Fälle:
- Das Lieblingsessen der Bioladenbesucher*innen (nominal)
- Das Verkehrsmittel, mit dem sie gekommen sind (nominal)
