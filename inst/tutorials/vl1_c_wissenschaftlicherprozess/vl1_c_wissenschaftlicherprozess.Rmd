...
Jetzt, wo wir alle unsere Datan schön in R eingelesen und aufgeräumt haben, wollen wir uns einen Eindruck verschaffen: Was haben wir da eigentlich erhoben?

Hier lade ich euch den Datensatz ins Tutorial:

```{r IV_Daten}
publictr <- load("data/publictr.rda")
```
...
Hier kommen ein paar sehr nützliche Befehle:

`datensatz`
`View(datensatz)`: Öffnet den kompletten Datensatz in einem neuen Tab im Skript-Fenster. Hier ist die 
