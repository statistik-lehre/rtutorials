...
Pakete können Daten und Funktionen enthalten. Erfahrene R-NutzerInnen veröffentlichen Pakete, um ihre Problemlösungen für andere verfügbar zu machen. Alle Menschen können Pakete veröffentlichen, die Daten und Funktionen enthalten. Wir nutzen heute ein solches Paket, um spielerisch den typischen Umgang mit Funktionen in R zu erlernen.
...
::: grau-nb
Tipp: Dass eine Funktion fertig ausgeführt ist, erkennen Sie daran, dass das rote Stoppzeichen ![](images/stop.PNG)oben rechts in der Konsole erlischt.
:::
