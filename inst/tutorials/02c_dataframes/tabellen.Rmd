...
(Anmerkung: Hier mehr Aufgaben einfügen, die zunächst "Spalte + Zahl sind oder so, bevor Spalte * Spalte kommt.)

::: aufgabe
Berechnen Sie eine neue Spalte namens `miete`, in dem Sie den Qudratmeterpreis `grundpreis` mit der Zimmergröße `quadratmeter` multiplizieren. 
