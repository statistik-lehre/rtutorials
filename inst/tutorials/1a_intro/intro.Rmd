...
::: gelb
Das hier ist nur eine Demo der Fähigkeiten, deswegen erklären wir an dieser Stelle nichts.
Wie genau alles funktioniert und zusammenhängt, werden Sie im Laufe des Semesters lernen. Keine Sorge, wir bringen Ihnen R von Grund auf bei.
:::
...
R Code, welcher eine animierte Grafik (GIF) erstellt, worin eine schrittweise Iteration der [Mandelbrot-Menge](https://de.wikipedia.org/wiki/Mandelbrot-Menge) gezeigt wird. 
...
=======
Da es etwas rechenintensiv ist, haben wir die Animation schon vorab hergestellt und zeigen den zugehörigen Quellcode, er kann aber nicht ausgeführt werden.
>>>>>>> d9d4d359e02740c28ee2e129194f47937176d549
