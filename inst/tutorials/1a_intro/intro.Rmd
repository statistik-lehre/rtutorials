...
Am Ende des Tutorials hast du die Möglichkeit, einen Hash zu generieren. Das ist ein lange Abfolge aus Textzeichen, die codiert den Inhalt der Antworten und den Fortschritt in diesem Tutorial speichern. Dieser Hash kann z.B. über Moodle zur Bewertung abgegeben werden und enthält deinen Fortschritt im Tutorial zu dem Zeitpunkt, zu dem der Hash generiert wurde. 
