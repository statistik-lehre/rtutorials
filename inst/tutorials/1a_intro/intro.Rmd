...
::: aufgaberstudio
**Aufgabe:**\
Gib nun auch wieder kleine Rechenaufgaben wie in der Konsole oben in dem Skript ein. Drücke `Strg` + `Enter`, um das jeweilige Statement auszuführen. Schau dann unten in die Konsole. Mach dich mit den Gleichheiten und Unterschiedlichkeiten vertraut, die Skript und Konsole haben.
:::
<br>
