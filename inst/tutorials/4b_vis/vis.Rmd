...
question("Welche Daten lassen sich gut in einem Punktediagramm darstellen?",
               ...
               answer("Zwei stetige Variablen.",
                      message = "Fast richtig. 
                      Es geht um stetige Daten, 
                      aber eben nur um eine einzelne Variable. 
                      Für diese Datenart eignet sich ein Punktdiagramm."),
               allow_retry = TRUE,
               random_answer_order = TRUE,
               correct = "Richtig!",
...
question("Plot 1: Wie alt ist die Person, die 600km Anreieweg hat ca.?",
               answer("ca. 40 Jahre alt.",
                     correct = T),
               answer("Über 75 Jahre alt."),
               answer("Zwischen 37 und 50 Jahren",
                      correct = T),
...
question("Was ist zu tun bei extremen Werten?",
               answer("Alles kleinstschrittig Dokumentieren.",
                      correct = TRUE),
...
Hierfür wird ein anderer Datensatz benötigt, da eine wiederholte Messung brauchen.
`einkaufen` enthält 160 unabhängige Messungen. Ein Liniendiagramm ist
geeignet, aufeinander aufbauende / sequentielle Messungen des selben Gegenstands darzustellen, wie zum
Beispiel einen Temperaturverlauf, wo jeden Tag über den ganzen Sommer hinweg die selbe Messung wiederholt wurde. \
Im Datensatz `rtutorials::heated` ist die maximale Tagestemperatur (`maxtemp`) in Grad Fahrenheit sowie das Tagesdatum (`enddate`) gespeichert.
