...
Bei Punktdiagrammen und Liniendiagrammen wird die Punkt- bzw. Linienfarbe durch `color` bestimmt. Wird das Attribut *Füllung* vergeben passiert einfach nichts. Probiere es gerne selbst aus und ändere `color` zu `fill`.

```{r am_f_color_2, exercise = TRUE, exercise.cap = "color im Scatterplot"}
ggplot(einkaufen, aes(x = alter, y = weg, color = bioladen)) +
  geom_point()
