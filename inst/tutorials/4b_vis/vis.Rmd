...
```{r boxplot-Beispiel, fig.width=2, exercise=TRUE, exercise.cap="Boxplot"}
...
- `essen`: Das Lieblingsessen der Person. Kategorial, 97 verschiedene Ausprägungen
- `verkehrsmittel`: Das Verkehrsmittel, mit dem die Person zum Bioladen gefahren ist. Kategorial, 7 Auprägungen
- `weg`: Die Länge der Anreise zum Bioladen in km, metrisch
- `alter`: Alter der Person, metrisch
- `kochen`:  Anzahl der Tage pro Woche, an denen selber gekocht wird, metrisch 
- `frequenz`: Wie oft die Person in einen Bioladen geht, ordinal, 5 Stufen
- `ort`: Befragungsort, kategorial, 5 Ausprägungen
- `bioladen`: Ob der Laden ein Bioladen war, kategorial, binär
- `befragung`: Kürzel der Studierenden, die die Daten erhoben haben, kategorial, 8 Ausprägungen
