...
Die Punkte aus den obigen Grafiken sind im Vektor `alter` gespeichert. Verwenden Sie die `quantile()`-Funktion, um sich die Quartile ausgeben zu lassen.
...
::: grau-nb
Standardmäßig werden die vier Quartile ausgegeben.
...
Ermitteln Sie den Wert, unterhalb dessen 95% aller Werte liegen!
