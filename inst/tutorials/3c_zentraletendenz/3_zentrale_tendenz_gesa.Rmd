...
Das Wort Kardinalskala ist ein Synonym für „metrisch“. Hier können wir die Abstände zwischen Werten sinnvoll interpretieren.

Eben haben wir festgelegt:

> Die zusammenfassende Zahl sollte den Fehler minimieren.

Als Fehler lässt sich hier gut die Abweichung von der zusammenfassenden Zahl beschreiben.
Wir möchten diese Abweichung also minimieren.

Beispiel: 

Wir nehmen eine Zahlenreihe, die wir durch eine Zahl zusammenfassen wollen. 
Diese Zahl sollte die geringstmögliche Abweichung haben von allen Werten. 
