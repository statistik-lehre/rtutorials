...
- Eine andere nicht nur unter Mathematikern beliebte Auszeichnungssprache, deren Stärke ist, Formeln schön darzustellen, heißt $\LaTeX$ (sprich "Latech").\
...
learnr::quiz(caption = "Testen Sie Ihr Verständnis",
             ...
             question_checkbox("Wählen Sie alle möglichen Wege aus, die Hilfe zur Funktion `say()` aufzurufen",
                            ...
                            answer("Den Cursor in die Funktion bewegen und F1 drücken", correct = TRUE),
                            allow_retry = TRUE,
                            random_answer_order = TRUE)
             )
```
