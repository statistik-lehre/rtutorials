...
Dann können wir nun endlich zum Hauptteil dieses Tutorials übergehen - jetzt wurde von Paketen gesprochen, die Funktionen bereitstellen sollen; nun wird es Zeit, dass Du mal eine Funktion in Aktion sehen.
...
::: blau-nb
Um in RStudio die Hilfe aufzurufen, geh mit dem Cursor in den Namen der Funktion (z.B. `say`) und drücken F1. Das funktioniert aber nicht im interaktiven Codeblock.
\
...
Diese Default-Werte findst Du in den Hilfeseiten unter dem Abschnitt **Usage**, und sie werden Ihnen in RStudio angezeigt in einem kleinen gelben Kästchen, sobald Du die Klammer hinter dem Funktionsnamen antippst.
...
Falls Sie noch kein Projekt erstellt haben, sollten Sie das tun - gehe dafür zurück zum letzten Tutorial, wo das erklärt wird.
