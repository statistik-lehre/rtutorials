...
Wir brauen also ein Streudiagramm, das wir für die Überprüfung schnell mit dem 
Befehl plot(variable1,variable2) erstellen können.
...
question_text("Überlege dir die inhaltliche Interpretation der beiden Regressionskoeffizienten! (Intercept = 37.29, weight = -5.34)",
              answer_fn(~ correct()),
              placeholder = "Eine Musterlösung erscheint, wenn Sie die Antwort einreichen, bitte vergleiche selbstständig.",
...
Wir haben unser Model als `fit` abgespeichert und wollen nun auch noch die letzten 
Tests durchführen.
