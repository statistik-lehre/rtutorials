...
Wenn Sie sich nicht gerade in einem learnr-Tutorial befinden, erscheint
das Objekt `x` im Environment, nachdem es erstellt wurde:

![](images/environment.png)

Auf Variablen, die sich im Environment befinden, kann in weiteren
Berechnungen Bezug genommen werden.
...
wurden und deswegen in der Umgebung verfügbar sind. Ansonsten bekommen
...
Mit `c()` lassen sich mehrere Vektoren aneinander zu binden. Kombinieren
...
Sehr gut! Nun beschäftigen wir uns damit, wie Rechnen mit Vektoren
funktioniert.
...
Sehr gut! Sie haben nun einige fundamentale Bestandteile der
Programmiersprache R in Aktion gesehen.
...
Sobald ein einziges Element eines Vektors Text ist, wird der ganze
Vektor zu einem Textvektor und die Zahlen stehen nicht mehr für
Berechnungen zur Verfügung. Diese automatische Umwandlung heißt
**coercion**.
:::

Erstellen Sie selbst einen gemischten Vektor aus Text und Zahlen und
beobachten, was passiert, wenn Sie ihn mit 1 addieren!
