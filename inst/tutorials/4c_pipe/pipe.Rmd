...
::: blau-nb
Aus dem Paket `dplyr` kommt die hilfreiche Funktion `filter()`. Diese können wir nutzen, um bestimmte Daten aus unserem Datensatz zu filtern.
...
Achte auf die Spalte "Essen" (auf Seite 2 der Tabelle)! Im ganzen Datensatz werden nur noch Zeilen angezeigt, die als Essen "Pizza" angegeben haben.
:::
...
Schau dir die Funktionsweise der Funktion `filter()` aus dem `dplyr`-Paket an und nutze sie für diese Aufgabe.
