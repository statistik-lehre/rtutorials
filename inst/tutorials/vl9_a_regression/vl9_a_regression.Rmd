...
Es mag willkürlich erscheinen, rein aus dem Visuellen grob zu bestimmen, ob etwas normalverteilt ist oder nicht. Hier sind einige Beispiele für nicht-normalverteilte Daten, damit Sie eine Intuition entwickeln. 

##### Definitiv Nicht-Normalverteilte Daten
##### a) multimodale Verteilung

```{r}
(sin(1:40) + sin(40:1)) |> hist()
runif(40) |> hist()
```


##### Beispiele von kleinen Stichproben mit $n=40$ aus einer Normalverteilung
