...
```{r, echo = TRUE}
trees$Diameter <- trees$Girth * 2.54 # Umrechnen in cm und Umbennen
trees$Volume <- trees$Volume * 0.0283168466 # Umrechnen in m³
...
Geraden werden beschrieben durch lineare Funktionen. Unser Modell besteht also essentiell aus einer linearen Funktion!
