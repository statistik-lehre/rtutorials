...
ggplot2::ggplot(trees, aes(x = Diameter, y = Volume)) +
  geom_point() +
...
**Key-Takeaway**: Diese Formeln liefern per Definition die optimale Regressionsgerade mit minimalen Residuen!
