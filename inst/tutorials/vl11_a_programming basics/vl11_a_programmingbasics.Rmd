...
```{r solution_3, exercise = TRUE}

```

Und weils so Spaß und vllt. noch ein bisschen mehr Verständnis bringt hier nochmal ein fiktiver Datensatz, an dem wir fleißig rumfiltern können:
```{r}
dat <- data.frame(
  wohnort = rep()
)
