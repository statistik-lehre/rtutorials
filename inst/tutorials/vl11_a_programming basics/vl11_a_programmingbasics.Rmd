...
Und weils so Spaß und vllt. noch ein bisschen mehr Verständnis bringt hier nochmal ein fiktiver Datensatz, an dem wir fleißig rumfiltern können, führe bitte folgenden Code aus:

```{r operatoren_4, exercise = TRUE}
set.seed(20230928)
...
Nun haben wir einen Datensatz mit 50 Einträgen, drei Formen (Kreis, Quadrat, Dreieck), drei Farben (lila, türlis, gelb) und 3 Größen (1, 2, 3). Bisschen wie so ein Baukasten:

```{r operatoren_5, exercise = TRUE}
library(ggplot2)
