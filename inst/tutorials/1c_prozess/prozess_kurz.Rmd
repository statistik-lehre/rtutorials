...
```{r quiz}
question_checkbox(text = "Wann werden die statistischen Auswertungsmethoden festgelegt?",
                  answer("Nach der Datenerhebung"),
                  answer("Während der Datenerhebung"),
                  answer("Vor der Datenerhebung", correct = TRUE),
                  allow_retry = T
)
```
