...
Im Unialltag empfinde ich es als sehr hilfreich, für jedes entsprechende Modul ein eigenes Projekt anzulegen (also: Statistik-bachelor im Bachelor, Statistik-bachelor im Master, Vertiefte Statistik-bachelor im Master etc.). Solltest Du in die Forschung gehen wollen oder bereits Forschungsprojekte im Studium umsetzen empfiehlt es sich, auch hierfür jeweils eigene Projekte anzulegen. Wichtig ist dann, dass du schaust, immer im richtigen Projekt zu arbeiten.
...
::: aufgaberstudio
**Aufgabe:**\
Erstellen in R Studio ein Projekt mit dem Namen `Statistik-bachelor`
:::
